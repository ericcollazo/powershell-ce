...
# manager-1
docker-machine create --driver digitalocean --digitalocean-image "ubuntu-16-04-x64" --digitalocean-region "nyc3" --digitalocean-size "8gb" --digitalocean-access-token $apiToken manager-1
docker-machine ssh manager-1 docker swarm join --token $managerJoinToken $joinIp

# manager-2
docker-machine create --driver digitalocean --digitalocean-image "ubuntu-16-04-x64" --digitalocean-region "nyc3" --digitalocean-size "8gb" --digitalocean-access-token $apiToken manager-2
...
# worker-3
docker-machine create  --driver digitalocean --digitalocean-image "ubuntu-16-04-x64" --digitalocean-region "nyc3" --digitalocean-size "4gb" --digitalocean-access-token $apiToken worker-3
...
# dtr-1
docker-machine create --driver digitalocean --digitalocean-image "ubuntu-16-04-x64" --digitalocean-region "nyc3" --digitalocean-size "8gb" --digitalocean-access-token $apiToken dtr-1
docker-machine ssh dtr-1 docker swarm join --token $workerJoinToken $joinIp

# dtr-2
docker-machine create --driver digitalocean --digitalocean-image "ubuntu-16-04-x64" --digitalocean-region "nyc3" --digitalocean-size "8gb" --digitalocean-access-token $apiToken dtr-2
...
docker-machine ssh dtr-1 docker run -it --rm  docker/dtr:2.4.2 join --existing-replica-id $dtrId --ucp-node dtr-1  --ucp-url https://$manager0ip --ucp-username admin --ucp-password adminadmin --ucp-insecure-tls
docker-machine ssh dtr-2 docker run -it --rm  docker/dtr:2.4.2 join --existing-replica-id $dtrId --ucp-node dtr-2  --ucp-url https://$manager0ip --ucp-username admin --ucp-password adminadmin --ucp-insecure-tls
